	...
	var x1,y1,xCo1,yCo1;
	var x2,y2,x3,y3;
	var ax1=0,ay1=0,bx1=0,by1=150,cx1=200,cy1=150;
	var ax2=0,ay2=150,bx2=200,by2=0,cx2=400,cy2=150;
	var ax3=200,ay3=150,bx3=400,by3=0,cx3=400,cy3=150;
...
function  drawPoint11(x1,y1) {
		  ctx1.beginPath();
		  ctx1.fillStyle = "black";
		  ctx1.arc(x1,y1,5, 0, Math.PI * 2, true);
		  ctx1.fill();
          ctx1.strokeStyle="black";
		  ctx1.stroke;
		 }
function  drawPoint12(x2,y2) {
		  ctx1.beginPath();
		  ctx1.fillStyle = "black";
		  ctx1.arc(x2,y2,5, 0, Math.PI * 2, true);
		  ctx1.fill();
          ctx1.strokeStyle="black";
		  ctx1.stroke;
	}
function  drawPoint13(x3,y3) {
		  ctx1.beginPath();
		  ctx1.fillStyle = "black";
		  ctx1.arc(x3,y3,5, 0, Math.PI * 2, true);
		  ctx1.fill();
          ctx1.strokeStyle="black";
		  ctx1.stroke;
	}
